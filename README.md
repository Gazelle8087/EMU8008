...
8008データシートよりクランプ電流は1mA未満と見積り  
一方PICのクランプ電流上限は25mAと規定されているため  
...
高輝度LEDの中でも緑色(秋月販売コード 111635)は特に明るく  
このような用途にも使えて便利です。  
...
シリアルモニタは作者のJom LoopsさんがMITにてライセンスしていますので  
それを引き継ぎ、私の改変部分もMITとします。  
